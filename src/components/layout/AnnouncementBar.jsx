    ...
    <>
      ...
      {drawer && (
        ...
        >
          ...
          {/* Panel — auto height, scrolls as a whole if needed */}
          <div className="relative bg-white w-full max-w-md h-full shadow-2xl flex flex-col animate-slideIn overflow-y-auto">

            {/* Drawer header */}
            <div className="bg-brand-navy px-6 py-5 flex items-start justify-between gap-4 flex-shrink-0 sticky top-0 z-10">
            ...
            {/* Body — shrinks to fit content, no flex-1 stretch */}
            ...
            {/* Other updates — immediately after body, no push to bottom */}
            {updates.length > 1 && (
